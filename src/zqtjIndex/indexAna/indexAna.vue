        ...
        <div class="totalNum">
          <el-row>
            <el-col :span="7" class="colSide">
              <div v-for="(item,index) in countPercentData.slice(0,2)" class="totalCol">
            ...
            <el-col :span="7" class="colSide">
              <div v-for="(item,index) in countPercentData.slice(2,4)" class="totalCol">
                <div class="label">{{item.name}}</div>
                <div class="contentValue">
                  <div class="valueDiv">
                    <span class="valueName">数量：</span>
          ...
          <div class="fireFightingAll">
            <div class="fireLiDiv">
              <el-row>
                ...
                <el-col :span="4" class="fireliBg">
                  <div @click="toFire('亡人火灾',fightFire_data.intensive,'namesFire')">
...
export default {
  ...
  methods: {
    ...
    dateDetail() {
      ...
      if (dataJson) {
        this.dateValue = dataJson.dateValue;
      } else {
