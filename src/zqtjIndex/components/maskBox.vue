      ...
      <div class="showMoreDiv">
        <div class="nei">
          ...
          <div v-if="title =='交通事故'" class="content">
            ...
            <p
              class="content_item"
            >由于贵州道路弯多路陡，乡村道路、城市交通道路的交通事故救援占62.1%；其次是高速交通事故救援占22.5%，事故性质以追尾居多，各路段发生交通事故的概率比较平均。</p>
            <p class="content_item">
              <span class="yellowFont">从高速路分析，</span>全省有沪昆、兰海、杭瑞、厦蓉、蓉遵、汕昆、都香等高速公路，全长6453公里。据消防出警救援显示，
              <span
                class="redFont"
              >沪昆高速、杭瑞高速、兰海高速、夏蓉高速</span>是消防救援的重点。
            </p>
            <p class="content_item">
              <span class="yellowFont">沪昆高速</span>贵州境内全长约587公里，消防救援主要发生在沿线的
              <span class="redFont">盘州市、西秀区、关岭县、晴隆县、观山湖区，</span>事故主要以追尾、侧翻为主。
            </p>
            <p class="content_item">
              <span class="yellowFont">杭瑞高速</span>贵州境内全长约626公里，消防救援主要发生在
              <span class="redFont">湄潭县、水城县、碧江区、江口县、大方县，</span>事故主要以追尾、侧翻为主。
            </p>
            <p class="content_item">
              <span class="yellowFont">兰海高速</span>贵州境内全长约480公里，消防救援主要发生在沿线的
              <span class="redFont">独山县、汇川区、播州区、桐梓县、开阳县，</span>事故主要以追尾、侧翻为主。
            </p>
            <p class="content_item">
              <span class="yellowFont">厦蓉高速</span>贵州境内全长约665公里，消防救援主要发生在沿线的
              <span class="redFont">清镇县、都匀市、龙里县、三都县，</span>事故主要以追尾、侧翻为主。
            </p>
            <p class="title">(二)区县境内分析</p>
            <tableCom></tableCom>
            <div class="content_item">
              <ul>
                <li>交通事故救援排名前三的支队有贵阳支队、遵义支队、黔南支队。</li>
                <li>交通事故救援排名前10的大队有观山湖大队、水城县大队、西秀大队、南明大队、播州大队、清镇县大队、白云大队、盘州县大队、乌当大队、花溪大队。</li>
              </ul>
            </div>
            <p class="title">(三)事故性质分析</p>
            <div class="content_item">
              交通事故的事故性质繁多，但有三种事故类型占到交通事故接警总量的84.49%，这三种事故类型分别是追尾，占交通事故接警总量的42.1%；侧翻，占交通事故接警总量的28.39%，车辆自燃、起火，占交通事故接警总量的14%。
              <ul>
                <li>重点关注类型化危车辆处置，占比0.97%。</li>
                <li>1、2019年3月2日，沪昆高速鲁屯段，化危车辆处置，泄漏汽油3吨。</li>
                <li>2、2019年4月17日，碧江区川硐镇天生桥景区路段，化危车辆处置，运输雷管、炸药车辆翻车。</li>
                <li>3、2019年8月8日，安江高速江口路段，化危车辆处置，泄露溶剂油30kg。</li>
                <li>4、2019年8月9日，安江高速江口路段，危化车辆处置，汽油泄露10kg。</li>
                <li>5、2019年8月14日，汕昆高速顶效二号隧道段，化危车辆处置，泄漏柴油2.5吨。</li>
                <li>6、2019年8月22日，万山区下溪乡路段，化危车辆处理，泄漏30吨硫酸。</li>
                <li>7、2019年9月26日，道安高速湄潭县西河收费站旁边，化危车辆处置，罐车侧翻后，因罐车装载的为液化石油气，需要将罐体运输到安全地段，中队现场进行安保。</li>
              </ul>
            </div>
          </div>
          <!-- 救人 -->
          ...
          <div v-if="title == '开门'" class="content">
            <dialogopenDoor></dialogopenDoor>
          </div>
          <div v-if="title == '取马蜂窝'" class="content">
            <dialog-hornet></dialog-hornet>
          </div>
          <div v-if="title == '冲马路'" class="content">
            <dialog-road></dialog-road>
          </div>
          <div v-if="title == '送水'" class="content">
            <dialog-water></dialog-water>
          </div>
          <div v-if="title == '关水龙头'" class="content">
            <dialog-tap></dialog-tap>
          </div>
          <div v-if="title == '高空取物'" class="content">
            <dialog-sky></dialog-sky>
          </div>
          <div v-if="title == '抓动物'" class="content">
            <dialog-animal></dialog-animal>
          </div>
          <div v-if="title == '其他'" class="content">
            <dialog-other></dialog-other>
          </div>
          <!-- 以下是火灾分析 -->
          <div v-if="title == '地下建筑火灾'" class="content">
            <dialog-dense></dialog-dense>
          </div>
          <div v-if="title == '高层建筑火灾'" class="content">
            <dialogHighBuild></dialogHighBuild>
          </div>
          <div v-if="title == '人员密集场所火灾'" class="content">
            <dialog-hypogee></dialog-hypogee>
          </div>

          <div v-if="title == '其他重要场所火灾'" class="content">
            <dialog4></dialog4>
          </div>
          <div v-if="title == '化工火灾'" class="content">
            <dialog6></dialog6>
          </div>
          <div v-if="title == '交通工具火灾'" class="content">
            <dialog5></dialog5>
          </div>
          <div v-if="title == '特殊火灾'" class="content">
            <dialog7></dialog7>
          </div>
          <div v-if="title == '其他火灾'" class="content">
            <dialog8></dialog8>
          </div>
        </div>
...
// 社会救助
import dialogopenDoor from "./dialogopenDoor";
import dialogHornet from "./dialogHornet";
import dialogRoad from "./dialogRoad";
import dialogWater from "./dialogWater";
import dialogTap from "./dialogTap";
import dialogSky from "./dialogSky";
import dialogAnimal from "./dialogAnimal";
import dialogOther from "./dialogOther";

// 火灾分析
import dialogDense from "./dialogDense";
import dialogHighBuild from "./dialogHighBuild";
import dialogHypogee from "./dialogHypogee";
import dialog4 from "./dialog4"; //其它重要场所
import dialog5 from "./dialog5"; //交通工具火灾
import dialog6 from "./dialog6"; //化工火灾
import dialog7 from "./dialog7"; //特殊火灾
import dialog8 from "./dialog8"; //其它火灾
